 ...
 */
export function positionMath(targetElement, scrollElement, margin) {
    ...
    if (downElementTop > 0)
        scrollElement.scrollTo({ top: scrollElement.scrollTop + downElementTop, behavior: "smooth" });
    if (upElementTop < 0)
        scrollElement.scrollTo({ top: scrollElement.scrollTop + upElementTop, behavior: "smooth" });
}
;
